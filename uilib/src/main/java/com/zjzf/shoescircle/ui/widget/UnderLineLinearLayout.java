...
public class UnderLineLinearLayout extends LinearLayout {
    ...
    public UnderLineLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int iconRes = attr.getResourceId(R.styleable.UnderLineLinearLayout_icon_src, 0);
        if (iconRes != 0) {
    ...
    private void initView(Context context) {
        ...
        firstPointPaint = new Paint(pointPaint);
        firstPointPaint.setColor(Color.parseColor("#FF434D"));
    }
    ...
    private void drawFirstChildViewVertical(Canvas canvas) {
        if (getChildAt(0) != null) {
            ...
            //画一个圆
            canvas.drawCircle(firstX, firstY, pointSize, firstPointPaint);
        }
    }
    ...
    public void addViewPreventLayout(View view) {
