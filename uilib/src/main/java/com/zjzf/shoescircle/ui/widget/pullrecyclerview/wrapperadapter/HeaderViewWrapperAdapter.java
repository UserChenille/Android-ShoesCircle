package com.zjzf.shoescircle.ui.widget.pullrecyclerview.wrapperadapter;
...
public class HeaderViewWrapperAdapter extends RecyclerView.Adapter implements WrapperRecyclerAdapter {
    ...
    public HeaderViewWrapperAdapter(RecyclerView recyclerView,
        ...
        if (mWrappedAdapter instanceof BaseRecyclerViewAdapter) {
            ((BaseRecyclerViewAdapter) mWrappedAdapter).setHeaderViewCount(mHeaderViewInfos == null ? 0 : mHeaderViewInfos.size());
            ((BaseRecyclerViewAdapter) mWrappedAdapter).setFooterViewCount(mFooterViewInfos == null ? 0 : mFooterViewInfos.size());
