...
public class StrokeRelativeLayout extends RelativeLayout implements IStrokeLayouts {
    ...
    public StrokeRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public StrokeRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.StrokeRelativeLayout);
            excludeSide = a.getInt(R.styleable.StrokeRelativeLayout_exclude_side, EXCLUDE_NONE);
            strokeWidth = a.getDimensionPixelSize(R.styleable.StrokeRelativeLayout_stroke_width, 2);
            strokeColor = a.getColor(R.styleable.StrokeRelativeLayout_stroke_color, 0xFFCCCCCC);
            a.recycle();
        } else {
