...
public class StrokeLinearLayout extends LinearLayout implements IStrokeLayouts {
    ...
    public StrokeLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public StrokeLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
