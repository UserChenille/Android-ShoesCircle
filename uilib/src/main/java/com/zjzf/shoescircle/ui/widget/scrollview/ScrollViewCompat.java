...
public class ScrollViewCompat extends ScrollView {
    ...
    public ScrollViewCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ScrollViewCompat(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
