package com.zjzf.shoescircleandroid.base.download;
...
import com.zjzf.shoescircle.lib.utils.EncryUtil;
...
public class DownloadService extends Service {
    ...
    private synchronized void cancelDownload(String url) {
       ...
       EventBusUtil.post(new DownloadEvent(url, -1, 0));
    }
    ...
    private synchronized void startDownload(String url) {
        ...
        LogHelper.trace( "保存地址 = " + downSavePath);
    ...
    public void updateView() {
        ...
        while (iterator.hasNext()) {
            ...
            // 发送广播通知
          EventBusUtil.post(downloadEvent);
