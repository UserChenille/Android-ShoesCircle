 ...
 * 已完成
 */
public class MyGoodsSellCompleteFragment extends BaseMyGoodsFragment {
    ...
    @LayoutId(id = R.layout.item_fragment_my_goods_sell_complete)
    private static class InnerViewHolder extends BaseMultiRecyclerViewHolder<GoodsSellInfo> {
        ...
        public InnerViewHolder(View itemView, int viewType) {
            ...
            this.tvDelete = (ExTextView) findViewById(R.id.tv_delete);
        }
