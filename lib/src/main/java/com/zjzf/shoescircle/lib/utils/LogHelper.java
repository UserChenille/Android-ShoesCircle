...
import com.zjzf.shoescircle.lib.BuildConfig;
...
public class LogHelper {
    ...
    public static final int d = 0x11;
    public static final int w = 0x12;
    public static final int e = 0x13;
    public static final int v = 0x14;
    ...
    public static void trace(@Method int method, String msg) {
        trace(method, TAG, msg);
    }

    public static void trace(@Method int method, Throwable throwable) {
        trace(method, TAG, throwable);
    }

    public static void trace(@Method int method, String tag, String msg) {
        trace(method, tag, msg, null);
    }

    public static void trace(@Method int method, String tag, Throwable throwable) {
        trace(method, tag, null, throwable);
    }

    public static void trace(@Method int method, String tag, String msg, Throwable throwable) {
     ...
     * @param content
     */
    private static void traceInternal(@Method int method, String tag, String content) {
        if (!LOG_LONG) {
    ...
    private static void logByMethod(@Method int method, String tag, String outPutMsg) {
        switch (method) {
            case i:
                Log.i(tag, outPutMsg);
                break;
    ...
    private static StackTraceElement getCurrentStackTrace() {
        ...
        int stackOffset = getStackOffset(trace, LogHelper.class);
        if (stackOffset == -1) {
